...
<head>
    ...
    <style type="text/css">
        ...
        .rfq-sheet:last-child { page-break-after: auto; }
        .rfq-sheet * { color: inherit; }
        ...
        .rfq-sheet table { border-collapse: collapse; }

        .rfq-sheet .header-table { width: 100%; }
        .rfq-sheet .header-table > tbody > tr > td { vertical-align: top; }
        .rfq-sheet .logo-cell { width: 55%; }
        .rfq-sheet .logo-cell img { max-height: 90px; max-width: 220px; }
        .rfq-sheet .meta-cell { width: 45%; text-align: right; }
        ...
        .rfq-sheet .meta-box { width: 100%; border: 1px solid #1f2d5c; }
        .rfq-sheet .meta-box td {
            border: 1px solid #ffffff;
            padding: 5px 8px;
            font-size: 11px;
        }
        .rfq-sheet .meta-box .label {
            background: #2f5c9e;
            color: #ffffff;
            text-align: left;
            width: 55%;
        }
        .rfq-sheet .meta-box .value { background: #ffffff; color: #222222; text-align: right; }
        .rfq-sheet .meta-box .validity { color: #d12f2f; font-weight: bold; }

        .rfq-sheet .company-name {
            font-size: 17px;
            font-weight: bold;
            color: #1f2d5c;
            margin: 16px 0 4px;
        }
        .rfq-sheet .company-block div { font-size: 11.5px; }

        .rfq-sheet .address-table { width: 100%; margin-top: 18px; }
        .rfq-sheet .address-table > tbody > tr > td { vertical-align: top; width: 50%; }
        .rfq-sheet .address-cell-left { padding-right: 12px; }
        .rfq-sheet .address-cell-right { padding-left: 12px; }
        .rfq-sheet .address-label { font-weight: bold; margin-bottom: 4px; }
        .rfq-sheet .address-box {
        ...
        .rfq-sheet .items-table { width: 100%; margin: 22px 0 10px; }
        .rfq-sheet .items-table th {
            background: #3e6db5;
            color: #ffffff;
            padding: 8px 10px;
            text-align: left;
        ...
        .rfq-sheet .items-table td {
            padding: 7px 10px;
            border: 1px solid #cfd6e0;
            font-size: 11.5px;
        }
        .rfq-sheet .items-table .num { text-align: right; }

        .rfq-sheet .totals-table { width: 100%; margin-top: 6px; }
        .rfq-sheet .totals-table > tbody > tr > td { vertical-align: top; }
        .rfq-sheet .totals-spacer { width: 55%; padding-right: 16px; }
        .rfq-sheet .notes-box {
            border: 1px solid #b9c2d0;
            min-height: 90px;
            padding: 8px 10px;
        ...
        .rfq-sheet .notes-box .notes-label {
            font-weight: bold;
            margin-bottom: 4px;
            color: #1f2d5c;
        }
        .rfq-sheet .notes-box p { margin: 0 0 4px; }
        .rfq-sheet .totals-box { width: 45%; }
        .rfq-sheet .totals-box table { width: 100%; }
        .rfq-sheet .totals-box td { padding: 6px 10px; font-size: 12px; }
        .rfq-sheet .totals-box .t-label { text-align: left; }
        .rfq-sheet .totals-box .t-value { text-align: right; }
        .rfq-sheet .totals-box .grand td {
            border: 1px solid #b9c2d0;
            font-weight: bold;
            font-size: 13px;
        }

        .rfq-sheet .footer-note { margin-top: 26px; font-size: 11px; color: #444444; }
    </style>
</head>
...
@foreach ($records as $record)
    ...
    <div class="rfq-sheet">
                    ...
                    <table class="meta-box">
                        ...
                        @if ($record->planned_at)
                            <tr>
                                ...
                                <td class="value validity">{{ $fmtDate($record->planned_at) }}</td>
                            </tr>
                        @endif
                    </table>
                </td>
        ...
        <div class="footer-note">
            We look forward to your quotation. Please contact us for any clarifications.
        </div>
    </div>
@endforeach
</body>
