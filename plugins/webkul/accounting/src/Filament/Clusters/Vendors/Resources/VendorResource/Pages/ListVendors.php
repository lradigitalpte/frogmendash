...
class ListVendors extends BaseListVendors
{
    ...
    {
        return __('accounting::filament/clusters/vendors/resources/vendor/pages/list-vendor.title');
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
            CreateAction::make()
                ->label(__('accounting::filament/clusters/vendors/resources/vendor/pages/list-vendor.header-actions.create.title'))
