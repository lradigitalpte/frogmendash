...
class ManageBankAccounts extends ManageRelatedRecords
{
    ...
    {
        return __('accounting::filament/clusters/vendors/resources/vendor/pages/manage-bank-account.title');
    }
    ...
    public function table(Table $table): Table
    {
        return BankAccountResource::table($table)
            ->headerActions([
                CreateAction::make()
                    ->label(__('accounting::filament/clusters/vendors/resources/vendor/pages/manage-bank-account.table.header-actions.create.title'))
